...
parse-rate and lifecycle distribution. By default each of the 5 themes
(momentum, mean_reversion, volatility_regime, volume_divergence,
calendar_effect) gets exactly 4 calls via interleaved-cyclic rotation
(``theme_slot = (k - 1) % THEME_CYCLE_LEN``; default ``THEME_CYCLE_LEN=5``).
