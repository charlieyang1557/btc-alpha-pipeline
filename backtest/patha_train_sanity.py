# backtest/patha_train_sanity.py
"""Train-window helpers for the Path A funding mechanism-sanity table.

Adapted near-verbatim from backtest/pathb_train_sanity.py. Parses
