# backtest/pathc_train_sanity.py
"""Train-window helpers for the Path C basis mechanism-sanity table.

Adapted near-verbatim from backtest/patha_train_sanity.py. Parses
