# tests/test_pathc_train_sanity.py
"""Train-only mechanism sanity: parse train_windows list; reject 2022/2024/2025.

Adapted from tests/test_pathb_train_sanity.py; retargeted to
backtest.pathc_train_sanity. Exercises load_train_windows, in_train_window, and
require_train_only (the three helpers present in pathc_train_sanity).
"""
...
import backtest.pathc_train_sanity as ts
