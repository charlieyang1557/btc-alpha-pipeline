...
**Sealed phase history**: full historical detail at [docs/phase_marker_history.md](docs/phase_marker_history.md). Compact summary of the 7 most recent register-events (B-iii sub-cycle + post-Path-D freeze current + 5 prior):
