...
| T1.5 SEAL ratify | PENDING | — | — | — | Charlie register on SEAL ratify fire; commits SEAL bundle per §7 |
| T1.5 SEAL commit + push | PENDING | — | — | — | per Charlie git operations register-event |
